    ...
    <div id="app">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo session()->get('email') ?></div>
                        </a>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            <a href="#" class="#"><i class="fas fa-home"></i><span>Booking Meeting Room</span></a>
                        </li>
        ...
        <script>
            ...
            $('.password').on('click', function() { // ketika tombol edit ditekan jalankan yg dibawah (button foreach)
                ...
                $.ajax({
                    url: "/user/getpassword/" + id, //proses getdata
                    method: "get",
                    dataType: "json",
                    success: function(data) { //aksi yang dilakukan setelah proses get data sukses
                        ...
                        $("#formedituser").attr('action', '/user/editpassword/' + id); //merubah form action edit (id form edit)
                    },
                });
            });
